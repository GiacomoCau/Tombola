	...
	//writeAll( C(2, 1, [1,1]) ) // 2
	//writeAll( C(2, 1, [2,2]) ) // 2
	
	//writeAll( C(2, 2, [2,1,2]) ) // 4 
	//writeAll( C(2, 2, [2,2,2]) ) // 6 
	//writeAll( C(2, 2, [2,1,2,2]) ) // 6
	//writeAll( C(2, 2, [2,2,2,2]) ) // 6

	//writeAll( C(3, 2, [2,1,2,2]) ) // 45 
	//writeAll( C(3, 2, [2,2,2,2]) ) // 90 
	//writeAll( C(3, 3, [3,2,2,2,3]) ) // 366 
	//writeAll( C(3, 4, [3,2,2,2,2,3]) ) // 540
	//writeAll( C(3, 4, [3,2,2,2,3,3]) ) // 906
	//writeAll( C(3, 4, [3,3,2,2,3,3]) ) // 1374
	//writeAll( C(3, 4, [3,3,3,3,3,3]) ) // 2640
	//writeAll( C(3, 4, [4,4,4,4,4,4]) ) // 2640
	//writeAll( C(3, 5, [3,3,2,2,3,3]) ) // 30
	
	//writeAll( C(3, 5, [3,3,3,3,3,3]) ) // 210
	//writeAll( C(3, 5, [4,4,4,4,4,4]) ) // 210
	
	//writeAll( C(3, 5, [3,3,3,3,3,3,3]) ) // 7700
	
	//writeAll( C(3, 5, [ 3, 3, 3, 3, 3, 3, 3, 3]) ) // 107.520
	//writeAll( C(3, 5, [10,10,10,10,10,10,10,10]) ) // 107.520
	
	//writeAll( C(3, 5, [ 2, 3, 3, 3, 3, 3, 3, 3, 3]) ) // 647.640
	//writeAll( C(3, 5, [ 2, 3, 3, 3, 3, 3, 3, 3, 4]) ) // 647.640
	
	//writeAll( C(3, 5, [ 3, 3, 3, 3, 3, 3, 3, 3, 3]) ) // 735.210
	//writeAll( C(3, 5, [ 3, 4, 4, 4, 4, 4, 4, 4, 5]) ) // 735.210
	//writeAll( C(3, 5, [ 9,10,10,10,10,10,10,10,11]) ) // 735.210
	//writeAll( C(3, 5, [10,10,10,10,10,10,10,10,10]) ) // 735.210
